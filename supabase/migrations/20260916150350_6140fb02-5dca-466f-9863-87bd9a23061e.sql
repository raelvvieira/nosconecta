-- lovable-cron-fallback-reviewed: 288 runs/day; o CRM não tem webhook de entrada, então a consulta periódica é a única forma de manter o espelho das conversas em dia

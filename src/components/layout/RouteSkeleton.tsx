...
export function RouteSkeleton({ shape = "list" }: { shape?: Shape }) {
  return (
    <div className="app-bg flex h-dvh overflow-hidden" aria-busy="true" aria-live="polite">
      ...
      <main className="custom-scroll min-w-0 flex-1 space-y-5 overflow-y-auto overflow-x-clip px-4 pb-nav pt-[calc(env(safe-area-inset-top)+52px)] md:px-6 lg:px-10 lg:pb-8 lg:pt-8">

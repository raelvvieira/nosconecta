...
function PagamentosPage() {
  ...
  return (
    <div className="app-bg h-dvh flex overflow-hidden">
      ...
      <main className="flex-1 min-w-0 overflow-y-auto sem-arrasto-lateral custom-scroll px-4 md:px-6 lg:px-10 py-6 md:py-8 space-y-6 md:space-y-8 pb-nav lg:pb-8">
        {/* Header */}
        <PageHeading
          icon={ArrowUpCircle}
          title="Pagamentos"
